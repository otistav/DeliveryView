...
const menuObject = {
  pizza:
    [{ cost: 5, name: 'cheesy', quantity: 0, img: '' }],

  meat:
    [{ cost: 20, name: 'goose', quantity: 0, img: '' }, { cost: 24, name: 'dog', quantity: 0, img: '' }],

  salad:
    [{ cost: 2, name: 'cesar', quantity: 0,img: '' }, { cost: 4, name: 'sea salad', quantity: 0,img: '' }, { cost: 10, name: 'qqq', quantity: 0,img: '' }],
